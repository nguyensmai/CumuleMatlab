...
for iPred=1:nPred
 ...
 pred(1) = FFN([51], [1], 20, inputsSet,1);  % good for env4 [s1 m1] -> s1
 pred(2) = FFN([1 2], [2], 20, inputsSet,1);  % good for env4 [s1 m1] -> s1
 pred(3) = FFN([1 ], [3], 20, inputsSet,1);  % good for env4 [s1 m1] -> s1
 pred(4) = FFN([51], [4], 20, inputsSet,1);  % good for env4 [s1 m1] -> s1
 ...
 pred(12) = FFN([1 2], [12], 3, inputsSet,1);  % good for env4 [s1 m1] -> s1
 pred(13) = FFN([1 ], [13], 5, inputsSet,1);  % good for env4 [s1 m1] -> s1
 pred(14) = FFN([6], [14], 5, inputsSet,1);  % good for env4 [s1 m1] -> s1
 pred(15) = FFN([6 7], [15], 5, inputsSet,1);  % good for env4 [s1 m1] -> s1
 ...
 pred(21) = FFN([6], [21], 20, inputsSet,1);  % good for env4 [s1 m1] -> s1
 pred(22) = FFN([1 2], [22], 3, inputsSet,1);  % good for env4 [s1 m1] -> s1
 pred(23) = FFN([1 ], [23], 5, inputsSet,1);  % good for env4 [s1 m1] -> s1
 pred(24) = FFN([6], [24], 5, inputsSet,1);  % good for env4 [s1 m1] -> s1
 pred(25) = FFN([6 7], [25], 5, inputsSet,1);  % good for env4 [s1 m1] -> s1
